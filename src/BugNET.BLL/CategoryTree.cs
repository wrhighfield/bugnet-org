...
namespace BugNET.BLL
{
    ...
    public class CategoryTree
    {
        ...
        {
            return unSortedCats.Where(cat => cat.ParentCategoryId == 0).ToList();
        }
        ...
        {
            return unSortedCats.Where(cat => cat.ParentCategoryId == parentId).ToList();
        }
