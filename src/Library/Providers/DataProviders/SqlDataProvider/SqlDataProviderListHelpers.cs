...
namespace BugNET.Providers.DataProviders
{
    public partial class SqlDataProvider
    {
        ...
        public void GenerateDefaultValueListFromReader<T>(SqlDataReader returnData, ref List<DefaultValue> defaultList)
        {
            while (returnData.Read())
            {
                var defaultValues = new DefaultValue()
                {
                    ...
                    PriorityId =
                        returnData["IssuePriorityId"] == DBNull.Value ? 1 : (int) returnData["IssuePriorityId"],
                    AffectedMilestoneId = returnData["IssueAffectedMilestoneId"] == DBNull.Value
                        ? 1
                        : (int) returnData["IssueAffectedMilestoneId"],
                    IssueVisibility = returnData["IssueVisibility"] == DBNull.Value
                        ? 0
                    ...
                    MilestoneId = returnData["IssueMilestoneId"] == DBNull.Value
                        ? 0
                        : (int) returnData["IssueMilestoneId"],
                    Estimation = returnData["IssueEstimation"] == DBNull.Value
                        ? 0
                        : (decimal) returnData["IssueEstimation"],
                    ResolutionId = returnData["IssueResolutionId"] == DBNull.Value
                        ? 0
                        : (int) returnData["IssueResolutionId"],
                    StatusVisibility = returnData["StatusVisibility"] == DBNull.Value
                        ? true
                        : (bool) returnData["StatusVisibility"],
                    OwnedByVisibility = returnData["OwnedByVisibility"] == DBNull.Value
                        ? true
                        : (bool) returnData["OwnedByVisibility"],
                    PriorityVisibility = returnData["PriorityVisibility"] == DBNull.Value
                        ? true
                        : (bool) returnData["PriorityVisibility"],
                    AssignedToVisibility = returnData["AssignedToVisibility"] == DBNull.Value
                        ? true
                        : (bool) returnData["AssignedToVisibility"],
                    PrivateVisibility = returnData["PrivateVisibility"] == DBNull.Value
                        ? true
                        : (bool) returnData["PrivateVisibility"],
                    CategoryVisibility = returnData["CategoryVisibility"] == DBNull.Value
                        ? true
                        : (bool) returnData["CategoryVisibility"],
                    DueDateVisibility = returnData["DueDateVisibility"] == DBNull.Value
                        ? true
                        : (bool) returnData["DueDateVisibility"],
                    TypeVisibility = returnData["TypeVisibility"] == DBNull.Value
                        ? true
                        : (bool) returnData["TypeVisibility"],
                    PercentCompleteVisibility = returnData["PercentCompleteVisibility"] == DBNull.Value
                        ? true
                        : (bool) returnData["PercentCompleteVisibility"],
                    MilestoneVisibility = returnData["MilestoneVisibility"] == DBNull.Value
                        ? true
                        : (bool) returnData["MilestoneVisibility"],
                    EstimationVisibility = returnData["EstimationVisibility"] == DBNull.Value
                        ? true
                        : (bool) returnData["EstimationVisibility"],
                    ResolutionVisibility = returnData["ResolutionVisibility"] == DBNull.Value
                        ? true
                        : (bool) returnData["ResolutionVisibility"],
                    AffectedMilestoneVisibility = returnData["AffectedMilestoneVisibility"] == DBNull.Value
                        ? true
                        : (bool) returnData["AffectedMilestoneVisibility"],
                    StatusEditVisibility = returnData["StatusEditVisibility"] == DBNull.Value
                        ? true
                        : (bool) returnData["StatusEditVisibility"],
                    OwnedByEditVisibility = returnData["OwnedByEditVisibility"] == DBNull.Value
                        ? true
                        : (bool) returnData["OwnedByEditVisibility"],
                    PriorityEditVisibility = returnData["PriorityEditVisibility"] == DBNull.Value
                        ? true
                        : (bool) returnData["PriorityEditVisibility"],
                    AssignedToEditVisibility = returnData["AssignedToEditVisibility"] == DBNull.Value
                        ? true
                        : (bool) returnData["AssignedToEditVisibility"],
                    PrivateEditVisibility = returnData["PrivateEditVisibility"] == DBNull.Value
                        ? true
                        : (bool) returnData["PrivateEditVisibility"],
                    CategoryEditVisibility = returnData["CategoryEditVisibility"] == DBNull.Value
                        ? true
                        : (bool) returnData["CategoryEditVisibility"],
                    DueDateEditVisibility = returnData["DueDateEditVisibility"] == DBNull.Value
                        ? true
                        : (bool) returnData["DueDateEditVisibility"],
                    TypeEditVisibility = returnData["TypeEditVisibility"] == DBNull.Value
                        ? true
                        : (bool) returnData["TypeEditVisibility"],
                    PercentCompleteEditVisibility = returnData["PercentCompleteEditVisibility"] == DBNull.Value
                        ? true
                        : (bool) returnData["PercentCompleteEditVisibility"],
                    MilestoneEditVisibility = returnData["MilestoneEditVisibility"] == DBNull.Value
                        ? true
                        : (bool) returnData["MilestoneEditVisibility"],
                    EstimationEditVisibility = returnData["EstimationEditVisibility"] == DBNull.Value
                        ? true
                        : (bool) returnData["EstimationEditVisibility"],
                    ResolutionEditVisibility = returnData["ResolutionEditVisibility"] == DBNull.Value
                        ? true
                        : (bool) returnData["ResolutionEditVisibility"],
                    AffectedMilestoneEditVisibility = returnData["AffectedMilestoneEditVisibility"] == DBNull.Value
                        ? true
                        : (bool) returnData["AffectedMilestoneEditVisibility"],
                    AssignedToNotify = returnData["AssignedToNotify"] == DBNull.Value
                        ? true
                        : (bool) returnData["AssignedToNotify"],
                    OwnedByNotify = returnData["OwnedByNotify"] == DBNull.Value
                        ? true
                        : (bool) returnData["OwnedByNotify"],
        ...
        private static void GenerateIssueCountListFromReader(IDataReader returnData,
            ref List<IssueCount> issueCountList)
        {
            while (returnData.Read())
            {
        ...
        {
            while (returnData.Read()) issueList.Add(MapIssue(returnData));
        }
        ...
        {
            while (returnData.Read()) cultureCodes.Add((string) returnData["cultureCode"]);
        }
