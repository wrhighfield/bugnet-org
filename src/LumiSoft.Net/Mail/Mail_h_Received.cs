...
namespace LumiSoft.Net.Mail
{
    ...
    public class Mail_h_Received : MIME_h
    {
        ...
        public Mail_h_Received(string from, string by, DateTime time)
        {
            ...
            if (by == string.Empty) throw new ArgumentException("Argument 'by' value must be specified.", nameof(by));
        ...
        public override string ToString(MIME_Encoding_EncodedWord wordEncoder, Encoding parmetersCharset, bool reEncode)
        {
            if (reEncode || IsModified)
            {
                ...
                if (m_pFrom_TcpInfo != null) retVal.Append(" (" + m_pFrom_TcpInfo.ToString() + ")");
                retVal.Append(" by " + m_By);
                if (m_pBy_TcpInfo != null) retVal.Append(" (" + m_pBy_TcpInfo.ToString() + ")");
                if (!string.IsNullOrEmpty(m_Via)) retVal.Append(" via " + m_Via);
                if (!string.IsNullOrEmpty(m_With)) retVal.Append(" with " + m_With);
                if (!string.IsNullOrEmpty(m_ID)) retVal.Append(" id " + m_ID);
                if (!string.IsNullOrEmpty(m_For)) retVal.Append(" for " + m_For);
        ...
        public string From
        {
            ...
            set
            {
                if (value == null) throw new ArgumentNullException("From");
        ...
        public string By
        {
            ...
            set
            {
                if (value == null) throw new ArgumentNullException("By");
                if (value == string.Empty) throw new ArgumentException("Property 'By' value must be specified", "By");
