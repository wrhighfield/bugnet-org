...
namespace LumiSoft.Net.Mail
{
    ...
    public class Mail_h_MailboxList : MIME_h
    {
        ...
        {
            if (filedName == null) throw new ArgumentNullException(nameof(filedName));
            if (filedName == string.Empty) throw new ArgumentException("Argument 'filedName' value must be specified.");
