...
namespace LumiSoft.Net.MIME
{
    ...
    public class MIME_Entity : IDisposable
    {
        ...
        public void ToStream(Stream stream, MIME_Encoding_EncodedWord headerWordEncoder,
        ...
        protected internal void Parse(SmartStream stream, Encoding headerEncoding,
        ...
        public string ContentTransferEncoding
        {
            get
            {
                ...
                if (h != null) return ((MIME_h_Unstructured) h).Value.Trim();
        ...
        public MIME_b Body
        {
            ...
            set
            {
                if (value == null) throw new ArgumentNullException("Body");
