...
namespace BugNet.Web.Common.Helpers;

/// <summary>
/// <see cref="ITagHelper"/> implementation targeting &lt;span&gt; elements with an <c>asp-validation-for</c>
/// attribute.
/// </summary>
[HtmlTargetElement("div", Attributes = VALIDATION_FOR_ATTRIBUTE_NAME)]
public class ValidationMessageDivTagHelper : TagHelper
{
    private const string DATA_VALIDATION_FOR_ATTRIBUTE_NAME = "data-valmsg-for";
    private const string VALIDATION_FOR_ATTRIBUTE_NAME = "asp-validation-for";

    /// <summary>
    /// Creates a new <see cref="ValidationMessageDivTagHelper"/>.
    /// </summary>
    /// <param name="generator">The <see cref="IHtmlGenerator"/>.</param>
    public ValidationMessageDivTagHelper(IHtmlGenerator generator)
    {
        Generator = generator;
    }
    ...
    /// <summary>
    /// Gets the <see cref="IHtmlGenerator"/> used to generate the <see cref="ValidationMessageDivTagHelper"/>'s output.
    /// </summary>
    ...
    public override async Task ProcessAsync(TagHelperContext context, TagHelperOutput output)
    {
        ...
        if (For != null)
        {
            ...
            if (string.IsNullOrEmpty(For.Name) &&
                ...
                output.Attributes.ContainsName(DATA_VALIDATION_FOR_ATTRIBUTE_NAME))
            {
                htmlAttributes = new Dictionary<string, object>(StringComparer.OrdinalIgnoreCase)
                    {
                        { DATA_VALIDATION_FOR_ATTRIBUTE_NAME, "-non-empty-value-" },
                    };
            }
