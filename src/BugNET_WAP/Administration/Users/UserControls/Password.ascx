...
<div class="form-horizontal">
    <div class="form-group">
        <label class="col-md-2 control-label">
            <asp:Literal ID="PasswordLastChangedLabel" runat="server" Text="<%$ Resources:PasswordLastChanged %>"/>
        </label>
...
<asp:Panel ID="ChangePassword" runat="server">
    <div class="form-horizontal">
        <h3>
            <asp:Label ID="TitleLabel" Text="<%$ Resources:ChangePassword %>" runat="server"/>
        </h3>
        <div class="form-group">
...
<asp:Panel ID="ResetPassword" runat="server">
    <div class="fieldgroup" style="border: none">
        <h3>
            <asp:Label ID="Label1" runat="server" Text="<%$ Resources:ResetPassword %>"/>
        </h3>
