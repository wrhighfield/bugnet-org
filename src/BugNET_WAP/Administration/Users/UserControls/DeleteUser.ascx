...
<div>
    <p>
        <asp:Literal ID="DeleteUserText" runat="server" meta:resourcekey="DeleteUserText"/>
    </p>
    <p style="padding-top: 10px;">
        <asp:Literal ID="DeleteUserText2" runat="server" meta:resourcekey="DeleteUserText2"/>
    </p>
</div>
