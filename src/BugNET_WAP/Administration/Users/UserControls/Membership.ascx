...
<h2>
    <asp:Literal ID="ControlTitle" runat="server" Text="<%$ Resources:ControlTitle %>"/>
</h2>
<p>
...
<div class="form-horizontal">
    <div class="form-group">
        ...
        <div class="col-md-10">
            <asp:TextBox ID="UserName" runat="server" CssClass="form-control" Enabled="false" ReadOnly="true"/>
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        <label class="col-md-2 control-label">
            <asp:Literal ID="CreatedDateLabel" runat="server" Text="<%$ Resources:CreatedDate %>"/>
        </label>
        <div class="col-md-10">
    ...
    <div class="form-group">
        <label class="col-md-2 control-label">
            <asp:Literal ID="LastLoginDateLabel" runat="server" Text="<%$ Resources:LastLoginDate %>"/>
        </label>
        <div class="col-md-10">
            <p class="form-control-static">
    ...
    <div class="form-group">
        <label class="col-md-2 control-label">
            <asp:Literal ID="LastActivityDateLabel" runat="server" Text="<%$ Resources:LastActivityDate %>"/>
        </label>
        <div class="col-md-10">
            <p class="form-control-static">
