...
<h2>
    <asp:Literal ID="LogViewerTitle" runat="Server" Text="<%$ Resources:UserCustomFields %>"/>
</h2>
        ...
        <asp:TemplateColumn HeaderText="<%$ Resources:Field %>">
            ...
            <EditItemTemplate>
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" Text="<%$ Resources:SharedResources, Required %>"
                                            ControlToValidate="txtCustomFieldName" ValidationGroup="AddSelection" Display="Dynamic" CssClass="text-danger validation-error">
                                    ...
                                    <asp:TemplateColumn HeaderText="<%$ Resources: Name %>">
                                        ...
                                        <EditItemTemplate>
                                            ...
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" Text="<%$ Resources:SharedResources, Required %>"
                                                                        ControlToValidate="txtEditSelectionName" ValidationGroup="UpdateSelection" Display="Dynamic" CssClass="text-danger validation-error">
                                            </asp:RequiredFieldValidator>
                                        </EditItemTemplate>
                                        <FooterTemplate>
                                            ...
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" Text="<%$ Resources:SharedResources, Required %>"
                                                                        ControlToValidate="txtAddSelectionName" ValidationGroup="AddSelection" Display="Dynamic" CssClass="text-danger validation-error">
                                            </asp:RequiredFieldValidator>
                                        </FooterTemplate>
                                    </asp:TemplateColumn>
                                    ...
                                    <asp:TemplateColumn HeaderText="<%$ Resources: Value %>">
                                        ...
                                        <EditItemTemplate>
                                            ...
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" Text="<%$ Resources:SharedResources, Required %>"
                                                                        ControlToValidate="txtEditSelectionValue" ValidationGroup="UpdateSelection" Display="Dynamic" CssClass="text-danger validation-error">
                                            </asp:RequiredFieldValidator>
                                        </EditItemTemplate>
                                        <FooterTemplate>
                                            ...
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" Text="<%$ Resources:SharedResources, Required %>"
                                                                        ControlToValidate="txtAddSelectionValue" ValidationGroup="AddSelection" Display="Dynamic" CssClass="text-danger validation-error">
                                            </asp:RequiredFieldValidator>
                                        </FooterTemplate>
                                    </asp:TemplateColumn>
    ...
    <div class="form-group">
        ...
        <div class="col-md-10">
            ...
            <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" Display="Dynamic" ControlToValidate="txtName" ValidationGroup="AddCustomField"
                                        ErrorMessage="A name is required." SetFocusOnError="True" CssClass="text-danger validation-error">
            </asp:RequiredFieldValidator>
        </div>
    </div>
    <div class="form-group">
