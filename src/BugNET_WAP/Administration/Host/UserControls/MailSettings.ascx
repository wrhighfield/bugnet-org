...
<h2>
    <asp:Literal ID="Title" runat="Server" Text="<%$ Resources:MailSettings %>"/>
</h2>
    ...
    <ContentTemplate>
        <div class="form-horizontal">
            ...
            <div class="form-group" id="trSMTPDomain" runat="server">
                ...
                <div class="col-md-10">
                    <asp:TextBox ID="SMTPDomain" CssClass="form-control" runat="Server"/>
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-md-10">
                    <asp:TextBox ID="SMTPEmailTemplateRoot" CssClass="form-control" runat="Server"/>
                </div>
            </div>
        </div>
    </ContentTemplate>
