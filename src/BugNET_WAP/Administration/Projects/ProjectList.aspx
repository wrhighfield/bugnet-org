...
<asp:Content ContentPlaceHolderID="MainContent" runat="server" ID="Content1">
    ...
    <div style="padding:10px 0 10px 0;" class="pull-left">
        <span id="NewProject" runat="server" style="padding-right:5px; border-right:1px dotted #ccc">
            <a href='<%= ResolveUrl("~/Administration/Projects/AddProject") %>'>
                <img style="border:none;" src='<%= ResolveUrl("~/Images/application_add.gif") %>' class="icon"/>
            </a>
        ...
        <span id="CloneProject" runat="server">
            <a href='<%= ResolveUrl("~/Administration/Projects/CloneProject") %>'>
                <img style="border:none;" src='<%= ResolveUrl("~/Images/application_double.gif") %>' class="icon"/>
            </a>
