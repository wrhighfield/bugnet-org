...
<div>
    <h2>
        <asp:Literal ID="MailboxesTitle" runat="Server" meta:resourcekey="MailboxesTitle"/>
    </h2>
    <p>
    ...
    <asp:UpdatePanel ID="UpdatePanel2" runat="server">
        <ContentTemplate>
                    ...
                    <asp:TemplateColumn HeaderText="Email Address">
                        ...
                        <EditItemTemplate>
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" ValidationGroup="Update" runat="server" Display="Dynamic" ControlToValidate="txtEmailAddress"
                                                        ErrorMessage="Email address is required." SetFocusOnError="True" CssClass="text-danger validation-error">
            ...
            <div class="form-horizontal">
                <h3>
                    <asp:Literal ID="NewMailboxText" runat="server" Text="New Mailbox" meta:resourcekey="NewMailboxText"/>
                </h3>
