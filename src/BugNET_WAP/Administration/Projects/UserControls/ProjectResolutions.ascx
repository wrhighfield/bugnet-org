...
<div>
    <h2>
        <asp:Literal ID="ResolutionsTitle" runat="Server" meta:resourcekey="ResolutionsTitle"/>
    </h2>
    ...
    <asp:UpdatePanel ID="updatepanel1" runat="server">
        <ContentTemplate>
                    ...
                    <asp:TemplateColumn HeaderText="Resolution">
                        ...
                        <EditItemTemplate>
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" Display="Dynamic" runat="server" ControlToValidate="txtResolutionName"
                                                        ErrorMessage="Resolution name is required." CssClass="text-danger validation-error" SetFocusOnError="True">
            ...
            <div class="form-horizontal">
                <h3>
                    <asp:Literal ID="AddNewResolutionLabel" runat="Server" meta:resourcekey="AddNewResolutionLabel" Text="Add New Resolution"/>
                </h3>
