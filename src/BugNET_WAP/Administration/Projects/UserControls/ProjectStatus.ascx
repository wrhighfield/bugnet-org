...
<h2>
    <asp:Literal ID="StatusTitle" runat="Server" Text="<%$ Resources:SharedResources, Status %>"/>
</h2>
...
<asp:UpdatePanel runat="server" ID="UpdatePanel1">
    <ContentTemplate>
                ...
                <asp:TemplateColumn HeaderText="Status">
                    ...
                    <EditItemTemplate>
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtStatusName" Display="Dynamic"
                                                    ErrorMessage="A status name is required." SetFocusOnError="True" CssClass="text-danger validation-error">
        ...
        <div class="form-horizontal">
            <h3>
                <asp:Literal ID="AddNewStatusLabel" runat="Server" meta:resourcekey="AddNewStatusLabel" Text="Add New Status"/>
            </h3>
