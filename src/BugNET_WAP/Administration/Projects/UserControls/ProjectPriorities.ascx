...
<div>
    <h2>
        <asp:Literal ID="PrioritiesTitle" runat="Server" meta:resourcekey="PrioritiesTitle"/>
    </h2>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
                    ...
                    <asp:TemplateColumn HeaderText="Priority">
                        ...
                        <EditItemTemplate>
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" Display="Dynamic" ControlToValidate="txtPriorityName"
                                                        ErrorMessage="A priority name is required." SetFocusOnError="True" CssClass="text-danger validation-error">
            ...
            <div class="form-horizontal">
                <h3>
                    <asp:Literal ID="AddNewPriorityLabel" runat="Server" meta:resourcekey="AddNewPriorityLabel" Text="Add New Priority"/>
                </h3>
