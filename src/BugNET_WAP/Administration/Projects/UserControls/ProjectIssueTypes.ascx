...
<div>
    <h2>
        <asp:Literal ID="IssueTypesTitle" runat="Server" meta:resourcekey="IssueTypesTitle"/>
    </h2>
    ...
    <asp:UpdatePanel ID="UpdatePanel2" runat="server">
        <ContentTemplate>
                    ...
                    <asp:TemplateColumn HeaderText="Issue Type">
                        ...
                        <EditItemTemplate>
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" Display="Dynamic" ControlToValidate="txtIssueTypeName" CssClass="text-danger validation-error"
                                                        ErrorMessage="Issue Type name is required." SetFocusOnError="True">
            ...
            <div class="form-horizontal">
                <h3>
                    <asp:Literal ID="AddNewIssueTypeLabel" runat="Server" meta:resourcekey="AddNewIssueTypeLabel" Text="Add New Issue Type"/>
                </h3>
                <div class="form-group">
                    ...
                    <div class="col-md-10">
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" Display="Dynamic" ControlToValidate="txtName" CssClass="text-danger validation-error"
                                                    ErrorMessage="Issue Type name is required." SetFocusOnError="True" ValidationGroup="AddIssueType">
                        </asp:RequiredFieldValidator>
                    </div>
                </div>
                <div class="form-group">
                    <label for="<%= lstImages.ClientID %>" class="col-md-2 control-label">
                        <asp:Literal ID="Literal1" runat="server" Text="<%$ Resources:SharedResources, Image%>"/>
                    </label>
                    <div class="col-md-10">
