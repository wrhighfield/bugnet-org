...
<h2>
    <asp:Literal ID="MilestonesTitle" runat="Server" meta:resourcekey="MilestonesTitle"/>
</h2>
...
<asp:UpdatePanel ID="updatepanel1" runat="server">
    <ContentTemplate>
        ...
        <div class="form-horizontal">
            <h3>
                <asp:Literal ID="AddNewMilestoneLabel" runat="Server" meta:resourcekey="AddNewMilestoneLabel" Text="Add New Milestone"/>
            </h3>
