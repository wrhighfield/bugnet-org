...
<h2>
    <asp:Literal ID="ProjectMembersTitle" runat="Server" meta:resourcekey="ProjectMembersTitle"/>
</h2>
<p>
...
<div>
    <br/>
    <h3>
        <asp:Literal ID="Literal1" runat="Server" meta:resourcekey="AssignUserTitle"/>
    </h3>
</div>
<p>
