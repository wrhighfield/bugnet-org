...
<h2>
    <asp:Literal ID="SubversionTitle" runat="Server" meta:resourcekey="SubversionTitle"/>
</h2>
...
<div class="form-horizontal">
    ...
    <h3>
        <asp:Literal ID="Literal3" runat="Server" meta:resourcekey="CreateATagTitle"/>
    </h3>
    ...
    <h3>
        <asp:Literal ID="Literal1" runat="Server" meta:resourcekey="NewRepositoryTitle"/>
    </h3>
    ...
    <h3>
        <asp:Literal ID="Literal2" runat="Server" meta:resourcekey="SVNCommandsTitle"/>
    </h3>
    <div class="form-group">
        <div class="col-md-10">
