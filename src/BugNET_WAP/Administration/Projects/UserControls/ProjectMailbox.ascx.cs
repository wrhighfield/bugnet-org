...
namespace BugNET.Administration.Projects.UserControls
{
    ...
    /// </summary>
    public partial class Mailboxes : BugNetUserControl, IEditProjectControl
    {
        //*********************************************************************
        //
        ...
        {
            grdMailboxes.Columns[1].HeaderText = GetLocalString("EmailAddressLabel.Text");
            grdMailboxes.Columns[2].HeaderText = GetLocalString("IssueAssignedUserLabel.Text");
            grdMailboxes.Columns[3].HeaderText = GetLocalString("IssueTypeLabel.Text");
            grdMailboxes.Columns[4].HeaderText = GetLocalString("IssueCategoryLabel.Text");
        ...
        protected void dtgMailboxes_Delete(object source, DataGridCommandEventArgs e)
        {
        ...
        protected void dtgMailboxes_ItemDataBound(object s, DataGridItemEventArgs e)
        {
            ...
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                var message = string.Format(GetLocalString("ConfirmDelete"), currentMailbox.Mailbox.Trim());
        ...
        protected void dtgMailboxes_Update(object sender, DataGridCommandEventArgs e)
        {
            ...
            if (emailAddress.Text.Trim() == "") throw new ArgumentNullException("Email Address empty");
