...
namespace BugNET.Administration.Projects.UserControls
{
    ...
    /// </summary>
    public partial class ProjectSubversion : BugNetUserControl, IEditProjectControl
    {
        /// <summary>
        ...
        protected void createRepoBttn_Click(object sender, EventArgs e)
        {
            ...
            var rootUrl = HostSettingManager.Get(HostSettingNames.RepositoryRootUrl);
            if (!rootUrl.EndsWith("/"))
                rootUrl += "/";
        ...
        protected void createTagBttn_Click(object sender, EventArgs e)
        {
            ...
            if (tagComment.Text.Trim().Length == 0)
                ...
                svnOut.Text = SourceIntegrationManager.CreateTag(ProjectId, name, tagComment.Text,
                    tagUserName.Text.Trim(), tagPassword.Text.Trim());
        }
        ...
        {
            var projectToUpdate = ProjectManager.GetById(ProjectId);
            svnUrl.Text = projectToUpdate.SvnRepositoryUrl;

            var svnAdminEnabled = bool.Parse(HostSettingManager.Get(HostSettingNames.EnableRepositoryCreation));
            ...
            {
                createErrorLbl.Text = GetLocalString("RepositoryCreationDisabled");
