...
<tr>
    ...
    <td class="text-center">
        <asp:CheckBox ID="chkOwnedByVisibility" runat="server" Checked="True"/>
    </td>
    <td class="text-center">
        <asp:CheckBox ID="chkOwnedByEditVisibility" runat="server" Checked="True"/>
    </td>
    <td class="text-center">
...
<tr>
    ...
    <td class="text-center">
        <asp:CheckBox ID="chkPriorityVisibility" runat="server" Checked="True"/>
    </td>
    <td class="text-center">
        <asp:CheckBox ID="chkPriorityEditVisibility" runat="server" Checked="True"/>
    </td>
</tr>
<tr>
    <td>
    ...
    <td class="text-center">
        <asp:CheckBox ID="chkAffectedMilestoneVisibility" runat="server" Checked="True"/>
    </td>
    <td class="text-center">
        <asp:CheckBox ID="chkAffectedMilestoneEditVisibility" runat="server" Checked="True"/>
    </td>
</tr>
<tr>
    <td>
    ...
    <td class="text-center">
        <asp:CheckBox ID="chkAssignedToEditVisibility" runat="server" Checked="True"/>
    </td>
    <td class="text-center">
...
<tr>
    ...
    <td class="text-center">
        <asp:CheckBox ID="chkPrivateVisibility" runat="server" Checked="True"/>
    </td>
    <td class="text-center">
        <asp:CheckBox ID="chkPrivateEditVisibility" runat="server" Checked="True"/>
    </td>
</tr>
<tr>
    <td>
    ...
    <td class="text-center">
        <asp:CheckBox ID="chkCategoryVisibility" runat="server" Checked="True"/>
    </td>
    <td class="text-center">
        <asp:CheckBox ID="chkCategoryEditVisibility" runat="server" Checked="True"/>
    </td>
</tr>
<tr>
    <td>
    ...
    <td class="text-center">
        <asp:CheckBox ID="chkDueDateEditVisibility" runat="server" Checked="True"/>
    </td>
</tr>
<tr>
    <td>
    ...
    <td class="text-center">
        <asp:CheckBox ID="chkTypeVisibility" runat="server" Checked="True"/>
    </td>
    <td class="text-center">
        <asp:CheckBox ID="chkTypeEditVisibility" runat="server" Checked="True"/>
    </td>
</tr>
<tr>
    <td>
    ...
    <td class="text-center">
        <asp:CheckBox ID="chkPercentCompleteVisibility" runat="server" Checked="True"/>
    </td>
    <td class="text-center">
        <asp:CheckBox ID="chkPercentCompleteEditVisibility" runat="server" Checked="True"/>
    </td>
</tr>
<tr>
    <td>
    ...
    <td class="text-center">
        <asp:CheckBox ID="chkMilestoneVisibility" runat="server" Checked="True"/>
    </td>
    <td class="text-center">
        <asp:CheckBox ID="chkMilestoneEditVisibility" runat="server" Checked="True"/>
    </td>
</tr>
<tr>
    <td>
    ...
    <td>
        ...
        &nbsp;
        <small>
            <asp:Label ID="HoursLabel" runat="server" Text="<%$Resources:SharedIssueProperties, HoursLabel %>"/>
        </small>
    ...
    <td class="text-center">
        <asp:CheckBox ID="chkEstimationVisibility" runat="server" Checked="True"/>
    </td>
    <td class="text-center">
        <asp:CheckBox ID="chkEstimationEditVisibility" runat="server" Checked="True"/>
    </td>
</tr>
<tr>
    <td>
    ...
    <td class="text-center">
        <asp:CheckBox ID="chkResolutionVisibility" runat="server" Checked="True"/>
    </td>
    <td class="text-center">
        <asp:CheckBox ID="chkResolutionEditVisibility" runat="server" Checked="True"/>
    </td>
</tr>
</tbody>
</table>