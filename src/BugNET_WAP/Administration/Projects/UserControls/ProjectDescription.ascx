...
<h2>
    <asp:Literal ID="DetailsTitle" runat="Server" meta:resourcekey="DetailsTitle"/>
</h2>
...
<div class="form-horizontal">
    ...
    <div class="form-group">
        <asp:Label ID="Label4" AssociatedControlID="AllowAttachments"
                   CssClass="col-md-2 control-label" runat="server" meta:resourcekey="EnableAttachmentsLabel" Text="Enable Attachments:">
        </asp:Label>
        <div class="col-md-10">
            <div class="checkbox">
    ...
    <div class="form-group" id="AttachmentStorageTypeRow" runat="server">
        <asp:Label ID="Label12" CssClass="col-md-2 control-label"
                   AssociatedControlID="AttachmentStorageType" meta:resourcekey="AttachmentStorageTypeLabel" runat="server" Text="Storage Type">
        </asp:Label>
        <div class="col-md-8">
    ...
    <h3>
        <asp:Literal ID="Literal1" runat="Server" meta:resourcekey="SecurityTitle"/>
    </h3>
    <div class="form-group">
        <asp:Label ID="Label8" AssociatedControlID="rblAccessType" meta:resourcekey="AccessTypeLabel"
                   CssClass="col-md-2 control-label" runat="server" Text="Access Type:">
        </asp:Label>
        <div class="col-md-10">
