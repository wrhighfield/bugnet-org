        ...
        public static void RegisterOpenAuth()
        {
            ...
            if (HostSettingManager.Get(Common.HostSettingNames.TwitterAuthentication, false)
                ...
                OpenAuth.AuthenticationClients.AddTwitter(
                    HostSettingManager.Get(Common.HostSettingNames.TwitterConsumerKey),
                    HostSettingManager.Get(Common.HostSettingNames.TwitterConsumerSecret));
            ...
            if (HostSettingManager.Get(Common.HostSettingNames.FacebookAuthentication, false)
                ...
                OpenAuth.AuthenticationClients.AddFacebook(
                    HostSettingManager.Get(Common.HostSettingNames.FacebookAppId),
                    HostSettingManager.Get(Common.HostSettingNames.FacebookAppSecret));
            ...
            if (HostSettingManager.Get(Common.HostSettingNames.MicrosoftAuthentication, false)
                ...
                OpenAuth.AuthenticationClients.AddMicrosoft(
                    HostSettingManager.Get(Common.HostSettingNames.MicrosoftClientId),
                    HostSettingManager.Get(Common.HostSettingNames.MicrosoftClientSecret));
