...
namespace BugNET.UserControls
{
    ...
    /// </summary>
    public partial class PickCategory : BugNetUserControl
    {
        /// <summary>
        ...
        public int ItemCount => ddlComps.Items.Count;
        ...
        public string SelectedText => ddlComps.SelectedItem.Text;
        ...
        {
            get => int.Parse(ddlComps.SelectedValue);
            set
            {
                try
                {
        ...
        public override void DataBind()
        {
            ...
            ddlComps.DataSource = DataSource;
            ...
            if (DisplayDefault)
                ddlComps.Items.Insert(0, new ListItem(GetLocalString("SelectCategory"), "0"));
        }
    }
}