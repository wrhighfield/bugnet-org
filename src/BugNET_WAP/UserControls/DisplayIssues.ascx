...
<%@ Register Assembly="BugNET" Namespace="BugNET.UI.WebControls" TagPrefix="BNWC" %>
...
<asp:Panel ID="OptionsContainerPanel" runat="server" CssClass="issueListOptionsContainer">
    <div>
        ...
        <asp:Panel ID="LeftButtonContainerPanel" CssClass="leftButtonContainerPanel" runat="server">
            <asp:Label ID="ForSelectedLabel" runat="server" Text="For Selected" meta:resourceKey="ForSelectedLabel"/>&nbsp;
    ...
    <div id="SetProperties" style="display: none;">
        <h4>
            <asp:Label ID="Label10" runat="server" meta:resourcekey="SetPropertiesLabel"></asp:Label>
        </h4>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            ...
                            &nbsp;<asp:CheckBox ID="chkDueDateReset" runat="server"/>&nbsp;
                            <span>
                                <asp:Literal ID="litResetDueDate" meta:resourcekey="litResetDueDate" runat="server"></asp:Literal>
                            </span>
                        </div>
                    </div>
                </div>
    ...
    <asp:Panel ID="SelectColumnsPanel" Visible="False" runat="Server">
        <div id="ChangeColumns" style="display: none;">
            <h4>
                <asp:Literal ID="Literal3" runat="server" meta:resourcekey="SelectColumnsLiteral"></asp:Literal>
            </h4>
            <div>
...
<asp:Panel ID="ScrollPanel" runat="server" ScrollBars="Horizontal" Width="100%">
    <BNWC:GridView
        ...
        <Columns>
            ...
            <asp:TemplateField>
                <ItemTemplate>
                    <span runat="server" id="PrivateIssue">
                        <i class="fa fa-lock"></i><span class="sr-only">Private</span>
                    </span>
                </ItemTemplate>
            </asp:TemplateField>
