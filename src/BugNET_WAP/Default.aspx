...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div class="col-md-12">
        <div class="row">
            <div class="col-sm-3">
                <h3>
                    <asp:Label ID="lblApplicationTitle" runat="server">BugNET Issue Tracker</asp:Label>
                </h3>
                <div class="well">
            ...
            <div class="col-sm-9">
                ...
                <div class="jumbotron" id="BlankSlate" visible="false" runat="server">
                    <h1>
                        <asp:Localize ID="WelcomeLocalize" Text="Welcome to BugNET!" meta:resourceKey="WelcomeMessageHeader" runat="server"/>
                    </h1>
                    <p>
                        <asp:Localize ID="StartWorkLocalize" Text="[Resource Required]" meta:resourceKey="NoProjects" runat="server"/>
                    </p>
                    <ul class="list-unstyled">
                        <li>
                            ...
                            <asp:Localize runat="server" ID="Step1_Localize"/>
                        </li>
                        <li>
                            <span class="fa-stack fa-2x">
                                <i class="fa fa-circle fa-stack-2x number"></i>
                            ...
                            <asp:Localize runat="server" ID="Step2_Localize"/>
                        </li>
                        <li>
                            <span class="fa-stack fa-2x">
                                <i class="fa fa-circle fa-stack-2x number"></i>
                            ...
                            <asp:Localize runat="server" ID="Step3_Localize"/>
                        </li>
                    </ul>
                    <p>
                        <a class="btn btn-primary btn-lg" href="http://bugnet.codeplex.com/documentation" role="button" target="_blank">
                            <asp:Localize runat="server" ID="LearnMoreLocalize" meta:resourcekey="LearnMore"/>
                        </a>
                    </p>
                </div>
                <br>
                                                ...
                                                <li>
                                                    <div class="row" style="width: 325px; padding: 10px;">
                                                        <ul class="list-unstyled col-md-6">
                                                            ...
                                                            <li>
                                                                <a href="Projects/ProjectSummary/<%# ((Project) Container.DataItem).Id %>">
                                                                    <asp:Localize runat="server" ID="Localize33" Text="<%$ Resources:SharedResources, ProjectSummary %>"/>
                                                                </a>
                                                            </li>
                                                            <li>
                                                                <a href="Queries/QueryList/<%# ((Project) Container.DataItem).Id %>">
                                                                    <asp:Localize runat="server" ID="Localize4" Text="<%$ Resources:SharedResources, Queries %>"/>
                                                                </a>
                                                            </li>
                                                            <li>
                                                                <a href="Projects/ChangeLog/<%# ((Project) Container.DataItem).Id %>">
                                                                    <asp:Localize runat="server" ID="Localize5" Text="<%$ Resources:SharedResources, ChangeLog %>"/>
                                                                </a>
                                                            </li>
                                                            <li>
                                                                <a href="Projects/Roadmap/<%# ((Project) Container.DataItem).Id %>">
                                                                    <asp:Localize runat="server" ID="Localize6" Text="<%$ Resources:SharedResources, Roadmap %>"/>
                                                                </a>
                                                            </li>
                                                            <li id="ProjectCalendar" runat="server">
                                                                <a href="Projects/ProjectCalendar/<%# ((Project) Container.DataItem).Id %>">
                                                                    <asp:Localize runat="server" ID="Localize7" Text="<%$ Resources:SharedResources, Calendar %>"/>
                                                                </a>
                                                            </li>
                                                            <li id="ReportIssue" runat="server">
                                                                <a href="Issues/CreateIssue/<%# ((Project) Container.DataItem).Id %>">
                                                                    <asp:Localize runat="server" ID="Localize8" Text="<%$ Resources:SharedResources, NewIssue %>"/>
                                                                </a>
                                                            </li>
                                                            <li id="Settings" runat="server">
                                                                <a href="Administration/Projects/EditProject/<%# ((Project) Container.DataItem).Id %>/1">
                                                                    <asp:Localize runat="server" ID="Localize9" Text="<%$ Resources:SharedResources, EditProject %>"/>
                                                                </a>
                                                            </li>
                                                        </ul>
                                                        <ul class="list-unstyled col-md-6">
                                                            ...
                                                            <li>
                                                                <a href="Issues/IssueList.aspx?pid=<%# ((Project) Container.DataItem).Id %>">
                                                                    <asp:Label ID="Label1" runat="server" Text="All" meta:resourcekey="lblAll"/>
                                                                </a>
                                                            </li>
                                                            <li>
                                                                <a href="Issues/IssueList.aspx?pid=<%# ((Project) Container.DataItem).Id %>&amp;cr=1">
                                                                    <asp:Localize runat="server" ID="Localize10" Text="Created Recently" meta:resourcekey="CreatedRecently"/>
                                                                </a>
                                                            </li>
                                                            <li>
                                                                <a href="Issues/IssueList.aspx?pid=<%# ((Project) Container.DataItem).Id %>&amp;ur=1">
                                                                    <asp:Localize runat="server" ID="Localize11" Text="Updated Recently" meta:resourcekey="UpdatedRecently"/>
                                                                </a>
                                                            </li>
                                                            <li id="AssignedUserFilter" runat="server">
                                                                <asp:HyperLink ID="AssignedToUser" runat="server" meta:resourcekey="AssignedToUser">Assigned to me</asp:HyperLink>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                </li>
