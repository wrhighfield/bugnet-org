...
namespace BugNET.UI.WebControls
{
    ...
    public class SuckerMenuItem
    {
        ...
        public SuckerMenuItem(string sLink, string sText, MenuHelperRoot oRoot) : this(sLink, sText, oRoot,
            string.Empty)
        {
        }
        ...
        private readonly MenuHelperRoot root;
        ...
        public string GetHtml()
        {
            ...
            if (Items.Count > 0)
            {
                oBuilder.Append("<a href=\"" + Link + "\" class=\"dropdown-toggle\" data-toggle=\"dropdown\">" + Text +
                                "<b class=\"caret\"></b></a>");
