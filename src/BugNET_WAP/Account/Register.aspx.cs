namespace BugNET.Account
{
    ...
    public partial class Register : Page
    {
        ...
        protected void RegisterUser_CreatedUser(object sender, EventArgs e)
        {
            ...
            if (!OpenAuth.IsLocalUrl(continueUrl)) continueUrl = "~/";
            ...
            foreach (var r in roles.Where(r => r.AutoAssign)) RoleManager.AddUser(user.UserName, r.Id);
            ...
            if (HostSettingManager.Get(HostSettingNames.UserRegistration, (int) UserRegistration.Verified) ==
                (int) UserRegistration.Verified)
