...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    <h1>
        <asp:Label ID="lblTitle" runat="server" Text="Forgot Your Password?" style="color: #666" meta:resourcekey="lblTitle"></asp:Label>
    </h1>
            ...
            <div class="form-group">
                ...
                <div class="col-md-5">
                    ...
                    <asp:RequiredFieldValidator ID="UserNameRequired" runat="server" ControlToValidate="UserName"
                                                ErrorMessage="<%$ Resources:UsernameRequiredErrorMessage %>" CssClass="text-danger validation-error" ToolTip="<%$ Resources:UsernameRequiredErrorMessage %>">
