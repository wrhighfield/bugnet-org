            ...
            <asp:MultiView ID="ProfileView" ActiveViewIndex="0" runat="server">
                <asp:View ID="UserDetails" runat="server">
                    ...
                    <div class="form-horizontal">
                        <h2>
                            <asp:Literal ID="Literal3" runat="server" Text="[Resource Needed]" meta:resourceKey="UserDetails"/>
                        </h2>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-10">
                                ...
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" Display="Dynamic"
                                                            Text="<%$ Resources:SharedResources, Required %>" ControlToValidate="LastName">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-10">
                                ...
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" Display="Dynamic"
                                                            Text="<%$ Resources:SharedResources, Required %>" ControlToValidate="FullName">
                                </asp:RequiredFieldValidator>
                            </div>
                        </div>
                        <div class="form-group">
                ...
                <asp:View ID="Customize" runat="server">
                    ...
                    <h2>
                        <asp:Literal ID="Literal2" runat="server" Text="[Resource Needed]" meta:resourceKey="Preferences"/>
                    </h2>
                    <div class="form-horizontal">
                        <div class="form-group">
                ...
                <asp:View ID="Notifications" runat="server">
                    ...
                    <h2>
                        <asp:Literal ID="Label13" runat="server" meta:resourcekey="Notifications" Text="[Resource Needed]"/>
                    </h2>
                    <div class="form-horizontal">
                        <div class="form-group">
