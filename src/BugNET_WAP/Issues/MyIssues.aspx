            ...
            <div class="col-md-10">
                <div class="row">
                    <div class="col-md-5">
                        <div>
                            <strong>
                                <asp:Label ID="ProjectListFilterLabel" runat="server" Text="[Resource Needed]" meta:resourceKey="ProjectListFilterLabel"/>
                            </strong>
                        </div>
                        <div>
                    ...
                    <div class="col-md-3">
                        <div>
                            <strong>
                                <asp:Label ID="ViewIssuesFilterLabel" runat="server" Text="[Resource Needed]" meta:resourceKey="ViewIssuesFilterLabel"></asp:Label>
                            </strong>
                        </div>
                        <div>
