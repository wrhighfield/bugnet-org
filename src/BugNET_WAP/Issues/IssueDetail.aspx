            ...
            <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                <ContentTemplate>
                    ...
                    <h2 style="margin-top: 5px;">
                        <asp:Label ID="DisplayTitleLabel" runat="server" Visible="True" Text="Label"></asp:Label>
                    </h2>
                </ContentTemplate>
            </asp:UpdatePanel>
        </div>
    ...
    <ContentTemplate>
        <p>
            <asp:ImageButton ID="EditDescription" Visible="false" CssClass="icon" OnClick="EditDescriptionClick" CausesValidation="False"
                             CommandName="Edit" ImageUrl="~/images/pencil.gif" BorderWidth="0px" runat="server"/>&nbsp;
            <strong>
                <asp:Label ID="DescriptionLabel"
                           runat="server" Text="<%$ Resources:SharedResources, Description %>"/>
            </strong>
        </p>
